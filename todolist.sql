...
CREATE USER IF NOT EXISTS 'julessandoz'@'localhost' IDENTIFIED WITH mysql_native_password BY 'S4ndoz!Jules';

GRANT ALL PRIVILEGES ON todolist.* TO 'julessandoz'@'localhost' ;
